...
@section('main_content')
    ...
    <div class="container mobile-auth">
        ...
        <div class="extra-link-container">
            <a href="{{route('customer-auth.send-auth-confirm', ['mobile', $value])}}" class="extra-link right" title="ورود با کد یکبارمصرف">
                ورود با کد یکبارمصرف
            </a>
        </div>
        <div class="top-line-content">
            <form class="" action="{{route("customer-auth.do-password-auth", ['mobile', $value])}}" method="post">
                {{ csrf_field() }}
