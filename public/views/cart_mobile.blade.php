            ...
            @else
                        ...
                        @foreach($cartRows as $cartRow)
                            ...
                            <div product-box class="pd-list-item product-box cart-row"
                                ...
                                <div class="col product-details">
                                    <div class="row">
                                        <div class="col-lg-4 col-md-4 col-sm-5 col-xs-4 pr-0 pl-0">
                                ...
                                <div class="col price" product-id="{{$cartRow->product->id}}">
                                    <div class="unit-price">
                                        <span class="">مجموع قیمت: </span>
                ...
                <div class="button-wrapper">
                    ...
                    <button type="submit"
                            ...
                            class="btn btn-icon next col-xs-12 virt-form"
